...
const config: Config = {
    ...
    // Top-level hostname only, no trailing slash.
    url: "https://zeuz.ai",
    // Set the /<baseUrl>/ pathname under which your site is served
    // Site is hosted under the /docs/ subpath, so it needs leading + trailing slashes.
    baseUrl: "/docs/",
    ...
    presets: [
        [
            ...
            {
                docs: {
                    // Serve docs at the baseUrl root (/docs/<page>) rather than
                    // /docs/docs/<page>, since baseUrl already supplies the /docs/ segment.
                    routeBasePath: "/",
